...
class User extends Authenticatable implements LaratrustUser, MustVerifyEmail, JWTSubject
{
    ...
    public static function CompanySetting($id = null, $workspace_id = null)
    {
        ...
        if (!empty($id)) {
            ...
            $company_setting = [
                ...
                "title_text" => !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : "GTEXT",
                "footer_text" => !empty($admin_settings['footer_text']) ? $admin_settings['footer_text'] : "Copyright © GTEXT",
    ...
    public function updateUserPlanModules($plan_id = null, $duration = null, $modules = null, $counter = null, $user_id = null)
    {
        if ($user_id != null) {
            $user = User::find($user_id);
        } else {
