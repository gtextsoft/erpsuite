    ...
    public function index()
{
    ...
    {
        $cacheKey = 'roles_' . creatorId();
        $roles = Cache::remember($cacheKey, now()->addMinutes(10), function () {
            return Role::where('created_by', '=', creatorId())->with('permissions')->get();
        });
    ...
    public function edit(Role $role)
{
    if(Auth::user()->isAbleTo('roles edit'))
    {
        $permissions = Cache::remember('all_permissions', now()->addMinutes(10), function () {
