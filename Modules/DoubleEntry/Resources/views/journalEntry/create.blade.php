            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{Modules\DoubleEntry\Entities\JournalEntry::JournalNumberFormat($journalId)}}" readonly>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td></td>
                                <td class="text-end"><strong>{{__('Total Credit')}} ({{company_setting('defult_currancy_symbol')}})</strong></td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td class="text-end"><strong>{{__('Total Debit')}} ({{company_setting('defult_currancy_symbol')}})</strong></td>
