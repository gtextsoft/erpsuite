                                ...
                                <div class="border-start border-end">
                                        ...
                                        @if ($accounts != [] && $type != 'Assets')
                                            <div class="account-main-inner py-2">
                                                    ...
                                                    <div class="border-bottom py-2">
                                                        ...
                                                        <div class="account-inner d-flex align-items-center justify-content-between ps-4">
                                                            ...
                                                            <p class="fw-bold mb-2 text-end me-3">
                                                                {{ end($account['account']) == true ? currency_format_with_sym(end($account['account'])['netAmount']) : currency_format_with_sym(0) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="account-title d-flex align-items-center justify-content-between border-top border-bottom py-2 px-2 pe-0">
                                                    ...
                                                    <h6 class="fw-bold mb-0 text-end me-3">{{ currency_format_with_sym($total) }}</h6>
                                                </div>
                                                @php
                                                    if ($type != 'Assets') {
                                                        $totalAmount += $total;
                                    ...
                                    @if ($totalAmount != 0)
                                            <div
                                                ...
                                                <h6 class="fw-bold mb-0 text-end me-3">{{ currency_format_with_sym($totalAmount) }}</h6>
                                            </div>
                                    @endif
                                </div>
