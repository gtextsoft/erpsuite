                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="language" class="form-select" id="language">
                            @foreach (\Modules\AIAssistant\Entities\AssistantTemplate::flagOfCountry() as $key => $lang)
...
<script>
    function copyText() {
        ...
        if (selected == 'Component_Tag') {
            $('#Component_Tag').attr('value', copied);
        }


        if (selected == 'Category') {
            $('#Category').attr('value', copied);
        }

        if (selected == 'Description') {
            $('#Description').attr('value', copied);
        }
        ...
        if (input > 0) {
            ...
            } else if ($('textarea[name=' + selected + ']').hasClass('ckdescription')) {
                if ($('textarea[name=' + selected + ']').attr('id') != undefined) {
                    CKEDITOR.instances[$('textarea[name=' + selected + ']').attr('id')].setData(copied)
                }
            } else {
    ...
    function copySelectedText() {
        ...
        if (selected == 'Component_Tag') {
            $('#Component_Tag').attr('value', selectedText);
        }

        if (selected == 'Category') {
            $('#Category').attr('value', selectedText);
        }

        if (selected == 'Description') {
            $('#Description').attr('value', selectedText);
        }
        ...
        if (input > 0) {
            ...
            if ($('textarea[name=' + selected + ']').hasClass('pc-tinymce-2')) {
                ...
                $("#summernote-simple").summernote('code', selectedText);
            } else if ($('textarea[name=' + selected + ']').hasClass('ckdescription')) {
                if ($('textarea[name=' + selected + ']').attr('id') != undefined) {
                    CKEDITOR.instances[$('textarea[name=' + selected + ']').attr('id')].setData(copied)
                }
