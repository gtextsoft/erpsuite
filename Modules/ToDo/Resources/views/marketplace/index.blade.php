...
@php
    $path = url("packages/Modules/ToDo/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Task Management Simplified')}}</h2>
                <p>{{__('Effortlessly manage task stages, meetings, and personal ToDo lists within Dash SaaS, streamlining your workflow for enhanced productivity and organization.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Effortless Task Monitoring and Analysis')}}</h2>
                            <p>{{ __('Track task progress effortlessly with Dash SaaS\'s robust monitoring and analysis features. Gain insights into task completion rates, bottlenecks, and team performance with detailed analytics. Identify areas for improvement and optimize your workflow for maximum efficiency and productivity. With our comprehensive task management tools, stay ahead of deadlines and achieve your goals with confidence.') }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="subtitle"></div>
                            <h2>{{__('Efficiency at Your Fingertips')}}</h2>
                        </div>
                        <p>{{__('Maximize productivity with Dash SaaS\'s ToDo module, designed to streamline task management and boost efficiency. With customizable task stages and intuitive interfaces, stay organized and focused on completing tasks efficiently. From individual assignments to team projects, achieve more in less time with our comprehensive tools.')}}</p>
                    </div>
                </div>
            </div>
        </div>
