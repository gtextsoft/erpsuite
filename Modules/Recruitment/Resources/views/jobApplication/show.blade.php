            ...
            <div class="card-body job-app" >
                <h5 class="h4">
                    <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                        ...
                        <div>
                            <a href="{{ check_file($jobApplication->profile) ? get_file($jobApplication->profile) :get_file('uploads/users-avatar/avatar.png') }}" target="_blank" class="avatar rounded-circle avatar-sm">
                    ...
                    <div class="col-auto">
                     ...
                     @if($jobOnBoards == null)
                        <div class="col-12 text-end">
                            ...
                            data-ajax-popup="true" class="btn-sm btn btn-primary text-white" data-title="{{ __('Add to Job OnBoard') }}"
                    ...
                    <dd class="col-sm-9">
                        @if (!empty($jobApplication->resume))
                            <span class="text-sm action-btn bg-primary ms-2">
                                <a class=" btn btn-sm align-items-center" href="{{ get_file($jobApplication->resume)}}"
                                    data-bs-toggle="tooltip" data-bs-original-title="{{ __('download') }}"
                                    download=""><i class="ti ti-download text-white"></i></a>
                            </span>

                            <div class="action-btn bg-secondary ms-2 ">
                                <a class=" mx-3 btn btn-sm align-items-center" href="{{ get_file($jobApplication->resume)}}" target="_blank"  >
