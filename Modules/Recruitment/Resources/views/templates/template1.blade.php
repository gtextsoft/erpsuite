...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        .vertical-align-top tbody tr td:first-of-type ul li span {
            max-width: 100px;
            width: 100%;
            font-weight: 600;
        }

        .vertical-align-top tbody tr td:nth-child(2) ul li:first-of-type {
            margin-bottom: 10px;
        }
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h2>
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 83 83"
                                    width="83" height="83">
                                    <style>
                                        .a {
                                            fill: #2d2e31;
                        ...
                        <td style="max-width: 300px; max-height: 330px;">
                            <h2>
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 83 83"
                                    width="83" height="83">
                                    <style>
                        ...
                        @foreach ($job_candidate->JobExperienceCandidate as $job_experience_candidate)
                            @php
                                $endDate = Illuminate\Support\Carbon::parse(
                                    $job_experience_candidate['end_date']
                                );
                                $startDate = Illuminate\Support\Carbon::parse(
                                    $job_experience_candidate['start_date']
                                );
