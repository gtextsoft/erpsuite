...
@php
    $path = url('/Modules/Recruitment/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                                    ...
                                    <div class="tab-content active" id="tab-1">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl">{{ __('Billed monthly, or') }}
                                                <b>{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price']) . '/' }}</b>{{ __(' if paid monthly') }}
                                            </div>
                                            <div class="btn-group">
                                    ...
                                    <div class="tab-content" id="tab-2">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl">{{ __('Billed yearly, or') }}
                                                <b>{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price']) . '/' }}</b>{{ __(' if paid yearly') }}
                                            </div>
                                            <div class="btn-group">
                                                <a href="{{ route('apps.pricing') }}"
                                                    class="btn-secondary">{{ __('Buy Now') }} <svg
                                ...
                                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                    <div class="product-card-inner">
                                        ...
                                        <div class="product-content">
                                            <h4> <a href="product.html">{{ Module_Alias_Name($module->getName()) }}</a>
                                            </h4>
                                            <div class="price">
                                                <ins><span
                                                        class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price']) }}</span>
