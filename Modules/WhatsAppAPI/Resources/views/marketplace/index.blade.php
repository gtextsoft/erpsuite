...
@php
    $path = url("/Modules/WhatsAppAPI/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('More ')}}<b>{{__('Effective')}}</b>{{__(' With Whatsapp Notification')}}</h2>
                <p>{{__('Whatsapp channels are a wonderful tool, especially if you have a digital venture.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('End-to-End Encryption')}}</h2>
                        </div>
                        <p>{{__('Whatsapp is known for its end-to-end encryption, to the point that many specialists recommend it when talking about sensitive topics.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Settings Page for WhatsApp API')}}</h2>
                        </div>
                        <p>{{__('Enhance your Workdo-Dash experience with our customizable WhatsApp event notifications feature. Tailor your alerts by toggling events on and off, empowering users to stay connected and informed through seamless WhatsApp integration. Easily configure credentials for the WhatsApp API and manage event preferences within the settings section, ensuring a personalized and efficient communication workflow within your application.')}}</p>
                    </div>
                </div>
            </div>
        </div>
