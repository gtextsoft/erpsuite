...
@section('page-action')
    <div class="col-auto" style="width: 143px;">
        {{ Form::select('item_type', $product_type, \Request::route()->getName() == 'restaurant-item' ? 'restaurants' : null, ['id' => 'item_type', 'class' => 'form-control select ', 'required' => 'required', 'placeholder' => 'Select type']) }}
    </div>
@endsection
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('varient_name', __('Name'), ['class' => 'form-label']) }}<span
                                                class="text-danger">*</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('varient_name', '', ['class' => 'form-control']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('additional_price', __('Additional Price'), ['class' => 'form-label']) }}<span
                                                class="text-danger">*</span>
                                            <div class="form-icon-user">
                                                {{ Form::text('additional_price', '', ['class' => 'form-control']) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{ Form::label('item_attribute', __('Item Attribute'), ['class' => 'form-label']) }}<span
                                                class="text-danger">*</span>
                                            <div class="form-icon-user">
                                                {{ Form::select('item_attribute', $itemAttribute, null, ['class' => 'form-control', 'placeholder' => 'Select Item Attribute']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex radio-check">
                                            ...
                                            <div class="form-check form-check-inline form-group col-md-3">
                                                <input type="radio" id="in_active" value="Inactive" name="status"
    ...
    <script>
        $(document).ready(function() {
            $('#item_type').on('change', function() {
                ...
                $('.restaurant-varient').addClass('d-none');
                // Handle the visibility of the varient
