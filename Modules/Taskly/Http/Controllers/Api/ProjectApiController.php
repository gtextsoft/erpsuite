    ...
    public function index(Request $request)
    {
        try {
            ...
            $validator = \Validator::make(
                $request->all(), [
                    'type'        => 'in:Ongoing,Finished,OnHold',
...
public function projectDetails(Request $request)
{
    try {
        ...
        $totalMembers = (int) $project->users->count() 
                      + (int) $project->clients->count() 
                      + (int) $project->venders->count();
    ...
    public function destroyProject(Request $request)
    {
        try{
            ...
            $project = Project::where('workspace',$request->workspace_id)->where('created_by',creatorId())->where('id',$projectID)->first();
