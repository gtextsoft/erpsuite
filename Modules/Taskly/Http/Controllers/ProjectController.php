...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->isAbleTo('project manage')) {
            ...
            if (Auth::user()->hasRole('client')) {
                ...
                $projects = Project::projectonly()->where('workspace', '=', getActiveWorkSpace())->get();
            } else {
    ...
    public function ProjectSharedLink($id = null, $lang = null)
    {
        ...
        if ($project) {
            ...
            return view('taskly::projects.sharedlink', compact('company_id', 'workspace_id', 'project', 'id', 'lang', 'chartData', 'daysleft', 'stages', 'bug_stages', 'invoices', 'bills', 'documents'));
        } else {
