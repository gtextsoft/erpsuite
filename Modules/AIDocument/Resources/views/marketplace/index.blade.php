...
@php
    $path = url('Modules/AIDocument/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('AI WRITING ASSISTANT ') }}<b>{{ __('AND') }}</b>{{ __(' CONTENT GENERATOR TOOL') }}
                    </h2>
                    <p>{{ __('AI Document can quickly produce high-quality content, saving significant time compared to manual writing processes.') }}
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('Increased Productivity') }}</h2>
                            </div>
                            ...
                            <div class="theme-acnav">
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Time-Saving') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('With AI Document ability to generate content at scale, businesses can produce a large volume of articles, blog posts, social media content, and more, increasing productivity and content output..') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Cost-Effective') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('AI Document eliminates the need to hire or outsource content writers, reducing costs associated with content creation.') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="set has-children">
                                    <a href="javascript:;" class="acnav-label">
                                        ...
                                        <span>{{ __('Consistency') }}</span>
                                    </a>
                                    <div class="acnav-list">
                                        <p>{{ __('AI Document ensures consistency in tone, style, and brand voice throughout the generated content, maintaining a cohesive brand image.') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('Multilingual Capabilities & Plagiarism Prevention') }}</h2>
                            </div>
                            <p>{{ __('AI Document can create content in multiple languages, facilitating global reach and localization efforts.AI Document can detect and avoid plagiarism, generating original and unique content that meets ethical standards') }}
                            </p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                                    <div class="product-card-inner">
                                        ...
                                        <div class="product-content">
                                            <h4> <a href="product.html">{{ $module->name }}</a>
                                            </h4>
                                            <div class="price">
                                                <ins><span
                                                        class="currency-type">{{ super_currency_format_with_sym($module->monthly_price) }}</span>
                                            ...
                                            <a href="{{ route('software.details', $module->name }}"
