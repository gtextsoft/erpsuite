...
@section('page-action')
    <div class="float-end">
        <a href="{{ route('zoom-meeting.index') }}" class="btn btn-sm btn-primary me-1" data-bs-toggle="tooltip"
        ...
        @permission('zoommeeting create')
            <a href="#" data-size="lg" data-url="{{ route('zoom-meeting.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create Zoom Meeting') }}"
...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ asset('packages/workdo/ZoomMeeting/src/Resources/assets/css/main.css') }}">
@endpush
@section('content')
    <div class="row">
        <div class="col-md-8">
...
@push('scripts')
<script src="{{ asset('packages/workdo/ZoomMeeting/src/Resources/assets/js/main.min.js') }}"></script>
