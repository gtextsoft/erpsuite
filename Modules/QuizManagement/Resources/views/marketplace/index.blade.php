...
@php
    $path = url('packages/Modules/QuizManagement/src/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('Quiz Management is a system for creating, organizing, and evaluating quizzes efficiently. It allows administrators to manage questions, participants, and results while tracking performance seamlessly.') }}
                            </p>
                            <div class="price">
                                <ins><span
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Dash SaaS Quiz Management Module') }}</h2>
                    <p>{{ __("Manage quizzes, track progress, and enhance participant engagement effortlessly with Modules Dash's Quiz Management Module.") }}
                    </p>
                </div>
