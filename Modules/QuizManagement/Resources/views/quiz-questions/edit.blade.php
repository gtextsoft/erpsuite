{{ Form::model($quizQuestion, ['route' => ['quiz.questions.update', $quizQuestion->id], 'method' => 'PUT', 'class' => 'w-100 needs-validation ', 'novalidate']) }}
<div class="modal-body">
                ...
                <div class="d-flex gap-4">
                    <div class="form-check">
                        <input class="form-check-input" name="type" type="radio" id="mcq" value="mcq"
                            @if ($quizQuestion->type == 'mcq') checked @endif>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="type" type="radio" id="true_false" value="true_false"
                            @if ($quizQuestion->type == 'true_false') checked @endif>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="type" type="radio" id="descriptive"
                            value="descriptive" @if ($quizQuestion->type == 'descriptive') checked @endif>
    ...
    <div class="form-group">
        ...
        {{ Form::select('category_id', $categories, $quizQuestion->category_id, ['class' => 'form-control', 'placeholder' => 'Select Category']) }}
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12 repeater mcqs_repeater @if ($quizQuestion->type != 'mcq') d-none @endif"
                data-value='@json($quizQuestion->options)'>
                <div class="row">
                    <div class="col-12">
            ...
            <div class="form-group col-md-12 true_false_repeater @if ($quizQuestion->type != 'true_false') d-none @endif"
                data-value='@json($quizQuestion->options)'>
                <div class="row">
                    <div class="col-12">
                        <div class="row flex-grow-1">
