...
@php
    $path = url("/Modules/CustomField/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Would you like to collect additional information about modules then you can use custome filed.This feature allows you to gather more specific information.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Get')}}<b>{{__('Additional')}}</b>{{__('Information')}}</h2>
                <p>{{__('Bind fields to specific module.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Custom Filed')}}</h2>
                        </div>
                        <p>{{__('All you need to do is select a field from the list and the appropriate type. There are available five field types: Text, Date, Email, Number, and Textarea you will be able to show the custom fields without any additional effort.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Use All Modules')}}</h2>
                        </div>
                        <p>{{__('Custom Filed use in HRM, Account, Lead, Assests, Contract, Performance, Pos, Retainer, Sales, Taskly all modules.You can using custom filed collect additional information about all modules as you like.')}}</p>
                    </div>
                </div>
            </div>
        </div>
