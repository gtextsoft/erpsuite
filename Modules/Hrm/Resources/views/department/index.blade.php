...
@section('page-action')
    <div>
        @permission('department create')
            <a class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create New Department') }}"
                data-url="{{ route('department.create') }}" data-toggle="tooltip" title="{{ __('Create') }}">
                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-body table-border-style">
                            <h4>{{ !empty($company_settings['hrm_department_name']) ? $company_settings['hrm_department_name'] : __('Department') }}
                            </h4>
                        </div>
                        <div class="d-flex align-items-center px-4">
                            <div class="action-btn bg-info">
                                <a class="mx-3 btn btn-sm  align-items-center" data-url="{{ route('departmentname.edit') }}"
                                            ...
                                            <span>
                                                ...
                                                @permission('department delete')
                                                    <div class="action-btn bg-danger ms-2">
                                                        {{ Form::open(['route' => ['department.destroy', $department->id], 'class' => 'm-0']) }}
                                                        @method('DELETE')
                                                        <a class="mx-3 btn btn-sm  align-items-center bs-pass-para show_confirm"
                                                            ...
                                                            data-confirm-yes="delete-form-{{ $department->id }}"><i
