...
<div class="col-md-12">
    <div class="form-group">
        {{ Form::label('approved_by', __('Approved By'), ['class' => 'col-form-label']) }}
        {{ Form::select('approved_by', $users, null, ['class' => 'form-control', 'placeholder' => __('Select Approver'), 'required' => 'required']) }}
    </div>
</div>
