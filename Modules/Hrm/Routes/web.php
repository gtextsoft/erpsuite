...
use Modules\Hrm\Http\Controllers\RequisitionController;
// testing
/*
|--------------------------------------------------------------------------
| Web Routes
...
Route::group(['middleware' => 'PlanModuleCheck:Hrm'], function () {
    ...
    Route::middleware(['auth'])->post('/attendance/attendance', [AttendanceController::class, 'attendance'])->name('attendance.clockin')->middleware(
        [
            'auth',
        ]
    );
...
Route::get('requisitions/{requisition}/approve', [RequisitionController::class, 'approveForm'])->name('requisitions.approve.form')->middleware(['auth']);
Route::get('requisitions/{requisition}/reject', [RequisitionController::class, 'rejectForm'])->name('requisitions.reject.form')->middleware(['auth']);
Route::post('requisitions/{requisition}/approve', [RequisitionController::class, 'approve'])->name('requisitions.approve')->middleware(['auth']);
...
Route::get('leave/{id}/recommend', [LeaveController::class, 'recommend'])->name('leave.recommend')->middleware(
        [
            'auth',
        ]
    );
Route::get('leave/{id}/reject', [LeaveController::class, 'reject'])->name('leave.reject')->middleware(
        [
            'auth',
        ]
    );
Route::get('leave/{id}/approve', [LeaveController::class, 'approve'])->name('leave.approve')->middleware(
        [
            'auth',
        ]
    );
Route::get('leave/{id}/decline', [LeaveController::class, 'decline'])->name('leave.decline')->middleware(
        [
            'auth',
        ]
    );
    
    Route::post('leave/{id}/recommend', [LeaveController::class, 'recommendStore'])->name('leave.recommend.store')->middleware(
        [
            'auth',
        ]
    );
Route::post('leave/{id}/reject', [LeaveController::class, 'rejectStore'])->name('leave.reject.store')->middleware(
        [
            'auth',
        ]
    );
Route::post('leave/{id}/approve', [LeaveController::class, 'approveStore'])->name('leave.approve.store')->middleware(
        [
            'auth',
        ]
    );
Route::post('leave/{id}/decline', [LeaveController::class, 'declineStore'])->name('leave.decline.store')->middleware(
        [
            'auth',
        ]
    );
    ...
    Route::get('transfer/create-workspace', [TransferController::class, 'createWorkspace'])->name('transfer.create-workspace')->middleware(
        [
            'auth',
        ]
    );
    Route::post('transfer/store-workspace', [TransferController::class, 'storeWorkspace'])->name('transfer.store-workspace')->middleware(
        [
            'auth',
        ]
    );
    Route::get('transfer/{id}/edit-workspace', [TransferController::class, 'editWorkspace'])->name('transfer.edit-workspace')->middleware(
        [
            'auth',
        ]
    );
    Route::put('transfer/{id}/update-workspace', [TransferController::class, 'updateWorkspace'])->name('transfer.update-workspace')->middleware(
        [
            'auth',
        ]
    );
