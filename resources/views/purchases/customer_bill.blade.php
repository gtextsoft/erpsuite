    ...
    <div class="row justify-content-between align-items-center mb-3">
        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
            ...
            <div class="all-button-box mx-2">
                ...
                <a href="{{ route('purchases.pdf', \Crypt::encrypt($purchase->id))}}" target="_blank" class="btn btn-primary mt-3">
                    {{__('Download')}}
                </a>
            </div>
                                                ...
                                                @if(!empty($iteam->tax))
                                                    @php
                                                        ...
                                                        foreach($taxes as $taxe){
                                                            $taxDataPrice=App\Models\Purchase::taxRate($taxe->rate,$iteam->price,$iteam->quantity);
                                                        ...
                                                        @if(!empty($iteam->tax))
                                                            <table>
                                                                ...
                                                                @foreach($taxes as $tax)
                                                                    @php
                                                                        $taxPrice=App\Models\Purchase::taxRate($tax->rate,$iteam->price,$iteam->quantity);
