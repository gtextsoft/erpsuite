                    ...
                    <ul class="nav nav-pills nav-fill cust-nav information-tab" id="pills-tab" role="tablist">
                        @foreach ($notifications as $key => $value)
                            ...
                            @if (module_is_active($key) && $key == 'Whatsapp')
                                <li class="nav-item" role="presentation" id="whatsapp">
                                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#whatsapp-tab"
                                        type="button">{{ __('Whatsapp') }}</button>
                                </li>
                            @endif
                            @if (module_is_active($key) && $key == 'WhatsAppAPI')
                                <li class="nav-item" role="presentation" id="whatsappapi">
                                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#whatsappapi-tab"
                                        type="button">{{ __('Whatsapp Api') }}</button>
                                </li>
                            @endif
                            @if (module_is_active($key) && $key == 'SMS')
                                <li class="nav-item" role="presentation" id="sms">
                                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#sms-tab"
