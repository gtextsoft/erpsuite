...
class DefultSetting extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_setting = [
            ...
            "defult_language" => "en",
            "defult_timezone" => "Africa/Lagos",
            "title_text" => !empty(env('APP_NAME')) ? env('APP_NAME') : 'GTEXT',
            "footer_text" => "Copyright © " . (!empty(env('APP_NAME')) ? env('APP_NAME') : 'GTEXT'),
            "landing_page" => "on",
            "site_rtl" => "off",
            "cust_darklayout" => "off",
            "site_transparent" => "on",
            ...
            "meta_title" => "GTEXT",
            "meta_keywords" => "GTEXT ,SaaS solution,Multi-workspace functionality, Cloud-based access,Scalability,Multi-addons,Collaboration tool,Data management,Business productivity,Operational effectiveness",
